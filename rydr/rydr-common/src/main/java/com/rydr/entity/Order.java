...
public class Order {
    ...
    /**
     * This field corresponds to the database column tbl_order.fare_amount
     *
     * Structured fare for this order (settled at trip end). Replaces the fragile
     * memo="fare=xxx" text convention used by OrderServiceImpl.orderAmount().
     */
    ...
    /**
     * This method returns the value of the database column tbl_order.fare_amount
     *
     * @return the value of tbl_order.fare_amount
     */
    ...
    /**
     * This method sets the value of the database column tbl_order.fare_amount
     *
     * @param fareAmount the value for tbl_order.fare_amount
     */
